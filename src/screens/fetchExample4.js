...
export default function FetchExample4 ({navigation, route, shouldRefresh, categoryID }) {
  ...
  //const { content } = route?.params || {};
   ...
   const getPosts = async () => {
      ...
      //https://cs467api.uw.r.appspot.com/users?email=john@cheese.com   example-- a call with email 
        const response = await fetch('https://cs467api.uw.r.appspot.com/posts?category=' + categoryID, {method: 'GET'});
